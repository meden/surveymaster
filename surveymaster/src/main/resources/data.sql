...
insert into survey_orders (ID, REQUESTER_ID, SURVEY_ID, CHANNEL, STATUS ) values(-1, 1, 11, 'mail', 'processing');
insert into survey_orders (ID, REQUESTER_ID, SURVEY_ID, CHANNEL, STATUS ) values(-2, 1, 31, 'api', 'delivered');
